...
class Gallery_Images_Ape_Widget extends WP_Widget {
  ...
  public function widget( $args, $instance ) {
    ...
    if(!WPAPE_GALLERY_PREMIUM){
    	_e( 'Please activate', 'gallery-images-ape');
    	echo ' '.WPAPE_GALLERY_BUTTON_PREMIUM.' ';
    	_e( 'to enable this widget', 'gallery-images-ape');
    }
  ...
  public function form( $instance ) {
	...
	<?php 
	if(!WPAPE_GALLERY_PREMIUM){ ?>
    	<p><a href="https://wpape.net/open.php?type=gallery&action=premium" target="_blank"> <?php echo __( 'Please activate','gallery-images-ape').' '.WPAPE_GALLERY_BUTTON_PREMIUM;?> </a></p>     
	<?php } ?>
	<p>
