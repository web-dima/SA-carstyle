...
class apeGalleryMediaManagerClass extends Gallery_Images_Ape{
	...
	function hideFields(){
		echo "<style>.compat-attachment-fields tr.compat-field-wpape_gallery_line,.compat-attachment-fields tr.compat-field-wpape_gallery_col,.compat-attachment-fields tr.compat-field-wpape_gallery_line_premium,.compat-attachment-fields tr.compat-field-wpape_gallery_link{display:none;}";
			if(!WPAPE_GALLERY_PREMIUM) echo ".compat-attachment-fields tr.compat-field-wpape_gallery_type_link,.compat-attachment-fields tr.compat-field-wpape_gallery_video_link,.compat-attachment-fields tr.compat-field-wpape_gallery_effect{display:none; z-index: 1000;opacity: 0.4;pointer-events: none;}";
		echo "</style>";
	}
	...
	function initFields( $form_fields, $post ) {
		...
		$form_fields[WPAPE_GALLERY_NAMESPACE.'gallery_line'] = array(
			'label' => '',
			'input' => 'html',
			'html' 	=> ( '<h4>'.__('Gallery Ape', 'gallery-images-ape').'</h4>')
		);
