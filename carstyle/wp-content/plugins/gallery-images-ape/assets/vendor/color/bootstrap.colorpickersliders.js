  ...
  $.fn.ColorPickerSliders = function(options) {
    ...
    return this.each(function() {
      ...
      function showPopover(disableLastlyUsedGroupUpdate) {
        ...
        popover_container = $('<div class="cp-popover-container"></div>').appendTo( triggerelement.parents('.apeGalleryDiv'));
...
jQuery(function(){
  ...
  jQuery(".wpape_color").ColorPickerSliders({
  ...
  jQuery(".wpape_hover_bg_color").each(function(index, el) {
    var obj = jQuery(this);
    var color = obj.val();
