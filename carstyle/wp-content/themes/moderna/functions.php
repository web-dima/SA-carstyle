...
.uneditable-input:focus,input:focus  {";
		...
		echo "<link href='https://fonts.googleapis.com/css?family=$body_gfont' rel='stylesheet' type='text/css'>";
			$setting_css .= "body,h1,h2, h3, h4, h5, h6 {";
		...
		echo "<link href='https://fonts.googleapis.com/css?family=$_headingfont' rel='stylesheet' type='text/css'>";
			$setting_css .= ".pricing-box-alt .pricing-terms  h6,.post-quote blockquote,blockquote,.pullquote-left,.pullquote-right{";
...
function iwebtheme_enqueue_js() {
    ...
    wp_enqueue_script('spincrement', get_template_directory_uri() . '/js/jquery.spincrement.min.js','jquery', '1.9.2', TRUE);
    wp_enqueue_script('mosaic', get_template_directory_uri() . '/js/sapegin/jquery.mosaicflow.min.js','jquery', '1.9.2', TRUE);
