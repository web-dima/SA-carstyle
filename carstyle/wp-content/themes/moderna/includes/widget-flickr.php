...
function __construct() {
	...
	// Create the widget
	parent::__construct( 'iweb_flickr_widget', __('Flickr Photos', 'iwebtheme'), $widget_ops, $control_ops );
...
function widget( $args, $instance ) {
	...
	<script type="text/javascript" src="https://www.flickr.com/badge_code_v2.gne?count=<?php echo $postcount; ?>&amp;display=random&amp;size=s&amp;layout=x&amp;source=user&amp;user=<?php echo $flickrID; ?>"></script>
	</div>
