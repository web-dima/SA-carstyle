...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php } else { ?>
		...
		<div class="bottom-article">
            <i class="fa fa-calendar"></i> <?php the_time('F d, Y'); ?>
			<a href="<?php the_permalink(); ?>" class="pull-right"><?php echo __('Продолжить читать', 'iwebtheme'); ?> <i class="icon-angle-right"></i></a>
		</div>
		<?php } ?>
</article><!-- #post -->